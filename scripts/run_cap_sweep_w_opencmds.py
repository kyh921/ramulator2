...
for trace_name in TRACE_LIST:
    ...
    open_cfg["MemorySystem"]["Controller"]["plugins"] = [
    {"ControllerPlugin": {"impl": "ActCounterStats"}}
    ]
...
for trace_name, policy, cap, path in cases:
    ...
    row = {
        ...
        "read_row_nonhits_0": parse_stat(text, "read_row_nonhits_0"),
        "num_opening_cmds": parse_stat(text, "num_opening_cmds"),
...
for r in rows:
    display_rows.append({
        ...
        "read_nonhits": r["read_row_nonhits_0"],
        "opening_cmds": r["num_opening_cmds"],
